        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            <div class="banner-section">
                <div class="banner-img">
                    ...
                    @else
                        <img src="{{ $vcard->cover_url }}" class="{{ $coverClass }}" alt=""
                            loading="lazy">
                    @endif
                </div>
                                        ...
                                        <div class="contact-box d-flex align-items-center">
                                            ...
                                            <div class="contact-desc">
                                                ...
                                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                    class="fs-14 text-gray-200" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                        ...
                                        <div class="contact-box d-flex align-items-center">
                                            ...
                                            <div class="contact-desc">
                                                ...
                                                <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                    class="fs-14 text-gray-200" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
