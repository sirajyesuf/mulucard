                                        ...
                                        <div
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4 text-start">
                                                ...
                                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                    class="event-name text-center mb-0 text-white text-decoration-none" dir="ltr">+{{ $vcard->region_code }}
                                                    {{ $vcard->phone }}</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4 text-start">
                                                ...
                                                <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                                    class="event-name text-center mb-0 text-white text-decoration-none" dir="ltr">+{{ $vcard->alternative_region_code }}
