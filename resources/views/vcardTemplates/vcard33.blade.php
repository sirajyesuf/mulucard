                                        ...
                                        <div class="col-sm-6  mb-40">
                                            <div class="service-card h-100">
                                                ...
                                                <div class="card-body p-0">
                                                    ...
                                                    <p
                                                        class="mb-0 fs-14 text-gray {{ \Illuminate\Support\Str::length($service->description) > 80 ? 'more' : '' }}">
                                                        {!! $service->description !!}
                                                    </p>
                                                </div>
                                            </div>
            ...
            <div class="modal-dialog news-modal">
                <div class="modal-content animate-bottom" id="newsLatter-content">
                    <div class="newsmodal-header">
                        ...
                        <h1 class="newsmodal-title text-center mt-5" id="newsLatterModalLabel">
                            {{-- <i class="fa-solid fa-envelope-open-text text-gradient"></i> --}}
                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M25.2422 11.25H16.875H12.6328H11.25V12.2812V16.875V21.6094V32.0391L0.0234375 23.7305C0.210938 21.6094 1.30078 19.6406 3.03516 18.3633L5.625 16.4414V11.25C5.625 8.14453 8.14453 5.625 11.25 5.625H20.2266L26.0742 1.30078C27.2109 0.457031 28.582 0 30 0C31.418 0 32.7891 0.457031 33.9258 1.28906L39.7734 5.625H48.75C51.8555 5.625 54.375 8.14453 54.375 11.25V16.4414L56.9648 18.3633C58.6992 19.6406 59.7891 21.6094 59.9766 23.7305L48.75 32.0391V21.6094V16.875V12.2812V11.25H47.3672H43.125H34.7578H25.2305H25.2422ZM0 52.5V28.3711L25.5 47.2617C26.8008 48.2227 28.3828 48.75 30 48.75C31.6172 48.75 33.1992 48.2344 34.5 47.2617L60 28.3711V52.5C60 56.6367 56.6367 60 52.5 60H7.5C3.36328 60 0 56.6367 0 52.5ZM20.625 18.75H39.375C40.4062 18.75 41.25 19.5938 41.25 20.625C41.25 21.6562 40.4062 22.5 39.375 22.5H20.625C19.5938 22.5 18.75 21.6562 18.75 20.625C18.75 19.5938 19.5938 18.75 20.625 18.75ZM20.625 26.25H39.375C40.4062 26.25 41.25 27.0938 41.25 28.125C41.25 29.1562 40.4062 30 39.375 30H20.625C19.5938 30 18.75 29.1562 18.75 28.125C18.75 27.0938 19.5938 26.25 20.625 26.25Z"
                                    fill="url(#paint0_linear_4298_680)" />
                                <defs>
                                    <linearGradient id="paint0_linear_4298_680" x1="36.2903" y1="-21.5"
                                        x2="-7.18704" y2="-3.00555" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#158FFF" />
                                        <stop offset="1" stop-color="#01FCFF" />
                                    </linearGradient>
                                </defs>
                    ...
                    <div class="modal-body">
                        <h1 class="content text-center text-gradient p-lg-0">
