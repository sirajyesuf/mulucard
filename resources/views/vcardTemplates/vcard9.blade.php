                                        ...
                                        <div
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                ...
                                                <h5><a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="event-name text-center mb-0 text-decoration-none" dir="ltr">+{{ $vcard->region_code }}
                                                        {{ $vcard->phone }}</a>
                                                </h5>
                                            </div>
                                        </div>
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                ...
                                                <h5>
                                                    <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                                        class="event-name text-center mb-0 text-decoration-none" dir="ltr">+{{ $vcard->alternative_region_code }}
                                        ...
                                        <div class="contact-form px-sm-2">
                                            ...
                                            <div class="mb-3">
                                                <input type="tel" name="phone" class="form-control"
                                                    id="mobile" placeholder="{{ __('messages.form.phone') }}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)">
                                            </div>
                                            <div class="mb-3">
